...
class AnalyticsPipeline:
    ...
    def __init__(self, days_back: int = 365):
        ...
        self.results = {"models_trained": [], "analytics_computed": [], "errors": []}
    ...
    def _train_recovery_predictor(self, progress, task_id):
        ...
        try:
            ...
            feature_cols = [
                ...
                "hrv_deviation_from_avg",
                "rhr_deviation_from_avg",
                "strain_deviation_from_avg",
                # Cumulative strain
                "strain_3d_sum",
                # Temporal
                "day_of_week",
            ...
            console.print(
                f"[green]    ✅ Recovery Predictor trained (R²: {predictor.model_accuracy:.3f})[/green]"
            )
    ...
    def _train_sleep_predictor(self, progress, task_id):
        ...
        try:
            ...
            if len(df_clean) < 30:
                raise ValueError(
                    f"Insufficient clean data. Only {len(df_clean)} records after removing missing values."
                )

            X_train, X_test, y_train, y_test, _, _ = get_training_data(
                df_clean,
                target_col="sleep_efficiency_percentage",
                feature_cols=feature_cols,
                scale_features=False,
            )
            ...
            console.print(
                f"[green]    ✅ Sleep Efficiency Predictor trained (R²: {predictor.model_accuracy:.3f})[/green]"
            )
    ...
    def _train_factor_analyzer(self, progress, task_id):
        ...
        try:
            ...
            console.print(
                f"[green]    ✅ Factor Analyzer trained (R²: {predictor.model_accuracy:.3f})[/green]"
            )
    ...
    def _compute_summary(self, progress, task_id):
        ...
        try:
            ...
            summary = {
                ...
                "top_correlations": (
                    correlations.get("correlations", [])[:7] if correlations else []
                ),
