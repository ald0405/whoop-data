...
class WhoopFast:
    ...
    def authenticate(self):
        ...
        if self._load_tokens():
            if self._is_token_valid():
                ...
                raise Exception(
                    "No valid tokens available. Please authenticate with the main client first."
                )
        else:
    ...
    def make_single_request(
        self, data_endpoint: str, transform_for_db: bool = True, limit: int = 25
    ):
        """
