...
def iter_legacy_route_entries(
    ...
    """Iter legacy route entries.

    Args:
        route_entries: Input value for this routine.
    ...
    Example:
        # Example usage
        result = iter_legacy_route_entries(route_entries=...)
        _ = result
...
def build_legacy_route_index(
    ...
    Example:
        # Example usage
        result = build_legacy_route_index(route_entries=...)
        _ = result
...
def _annotate_legacy_routes_openapi(
    ...
    """ annotate legacy routes openapi.

    Args:
        schema: Input value for this routine.
        route_entries: Input value for this routine.
...
def configure_legacy_route_deprecation(
    ...
    """Configure legacy route deprecation.

    Args:
        app: Input value for this routine.
        route_entries: Input value for this routine.

    Example:
        # Example usage
        result = configure_legacy_route_deprecation(app=..., route_entries=...)
        _ = result
    ...
    async def add_legacy_route_headers(request: Request, call_next):
        """Add legacy route headers.

        Args:
            request: Input value for this routine.
            call_next: Input value for this routine.
        ...
        Example:
            # Example usage
            result = await add_legacy_route_headers(request=..., call_next=...)
            _ = result
