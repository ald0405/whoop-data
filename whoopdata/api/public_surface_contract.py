...
def build_legacy_route_guidance(target_path: str) -> str:
    ...
    Example:
        # Example usage
        result = build_legacy_route_guidance(target_path=...)
        _ = result
...
class PublicSurfaceDefinition:
    """PublicSurfaceDefinition type definition.
...
class CapabilityPlacementRule:
    """CapabilityPlacementRule type definition.
...
def get_surface_definition(surface: CanonicalSurface) -> PublicSurfaceDefinition:
    ...
    Example:
        # Example usage
        result = get_surface_definition(surface=...)
        _ = result
...
def surface_accepts_target(surface: CanonicalSurface, target_path: str) -> bool:
    ...
    Example:
        # Example usage
        result = surface_accepts_target(surface=..., target_path=...)
        _ = result
...
def surface_allows_route_kind(surface: CanonicalSurface, route_kind: RouteKind) -> bool:
    """Surface allows route kind.

    Args:
        surface: Input value for this routine.
        route_kind: Input value for this routine.
    ...
    Example:
        # Example usage
        result = surface_allows_route_kind(surface=..., route_kind=...)
        _ = result
...
def surface_allows_route_role(surface: CanonicalSurface, route_role: RouteRole) -> bool:
    """Surface allows route role.

    Args:
        surface: Input value for this routine.
        route_role: Input value for this routine.
    ...
    Example:
        # Example usage
        result = surface_allows_route_role(surface=..., route_role=...)
        _ = result
...
def surface_allows_entrypoint_role(
    ...
    """Surface allows entrypoint role.

    Args:
        primary_surface: Input value for this routine.
        entrypoint_role: Input value for this routine.
    ...
    Example:
        # Example usage
        result = surface_allows_entrypoint_role(primary_surface=..., entrypoint_role=...)
        _ = result
