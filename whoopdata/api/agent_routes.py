...
async def create_conversation(
    ...
    Args:
        payload: Input value for this routine.
        conversation_service: Input value for this routine.
    ...
    Example:
        # Example usage
        result = await create_conversation(payload=..., conversation_service=...)
        _ = result
...
async def send_message(
    ...
    Example:
        # Example usage
        result = await send_message(payload=..., conversation_service=...)
        _ = result
...
class TelegramPushRequest(BaseModel):
    """TelegramPushRequest type definition.
...
class TelegramPushResponse(BaseModel):
    """TelegramPushResponse type definition.
