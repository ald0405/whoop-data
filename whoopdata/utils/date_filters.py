...
def apply_recovery_date_filter(
    query: Query, start_date: Optional[str], end_date: Optional[str]
) -> Query:
    """
...
def apply_workout_date_filter(
    query: Query, start_date: Optional[str], end_date: Optional[str], use_start_time: bool = False
) -> Query:
    """
...
def apply_withings_date_filter(
    query: Query, start_date: Optional[str], end_date: Optional[str]
) -> Query:
    """
