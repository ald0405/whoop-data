...
class RecoveryPredictor:
    ...
    def predict(
        ...
        feature_names = self._aligned_feature_names()
    ...
    def get_feature_importance(self) -> Dict[str, float]:
        ...
        return {feat: float(imp * 100) for feat, imp in zip(feature_names, importance)}

    def _aligned_feature_names(self) -> list[str]:
        ...
        # Rare fallback when saved names are shorter than model feature count.
        # Keep existing names and append placeholders to preserve shape.
        missing = expected - len(names)
        return names + [f"feature_{i}" for i in range(missing)]
