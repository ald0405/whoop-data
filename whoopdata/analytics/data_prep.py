...
def _datetime_to_clock_minutes(series: pd.Series) -> pd.Series:
    """ datetime to clock minutes.

    Args:
        series: Input value for this routine.
...
def _circular_minute_delta(current: pd.Series, reference: pd.Series) -> pd.Series:
    """ circular minute delta.

    Args:
        current: Input value for this routine.
        reference: Input value for this routine.
...
def _circular_rolling_std(series: pd.Series, window: int) -> pd.Series:
    """ circular rolling std.

    Args:
        series: Input value for this routine.
        window: Input value for this routine.
