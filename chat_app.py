...
async def chat_with_agent(message: str, history: List[Tuple[str, str]], thread_id: str = None) -> Tuple[List[Tuple[str, str]], str]:
    """
    ...
    try:
        ...
        if result and "messages" in result:
            ...
            agent_response = "I'm having trouble processing your request right now. Please try again."
